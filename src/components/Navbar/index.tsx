    ...
    return (
        <nav className="bg-[#121212] py-2">
            <div className="flex justify-between items-center lg:w-[80%] md:w-[90%] w-[95%] mx-auto">
                <div className="flex lg:space-x-16 space-x-8 scale-x-1">
                    <Link to="/">
                        <div className="flex flex-col text-yellow-500 sm:scale-100 sm:scale-[70%]">
                ...
                <div className="relative">
                    <input
                        ...
                        md:text-lg sm:text-md text-sm outline-none sm:px-4 px-3
